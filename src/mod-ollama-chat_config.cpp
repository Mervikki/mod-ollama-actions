...
bool g_EnableNaturalLanguageCommands = true;
bool g_CommandDetectionRequireKeywords = true;
...
void LoadOllamaChatConfig()
{
    ...
    g_EnableNaturalLanguageCommands = sConfigMgr->GetOption<bool>("OllamaChat.EnableNaturalLanguageCommands", true);
    g_CommandDetectionRequireKeywords = sConfigMgr->GetOption<bool>("OllamaChat.CommandDetectionRequireKeywords", true);
...
{
    ProcessPendingNaturalCommandResults();
}
